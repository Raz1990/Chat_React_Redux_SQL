...
function getGroupMembers(group_id, justChecking) {
    return new Promise(function (resolve, reject) {
...
function moveGroups(groups) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        var usersNumber, insertId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getGroupMembers(groups.host, true)];
                case 1:
                    usersNumber = _a.sent();
                    if (!(usersNumber > 0)) return [3 /*break*/, 4];
                    return [4 /*yield*/, addGroup("temp", groups.host)];
                case 2:
                    insertId = _a.sent();
                    return [4 /*yield*/, moveUsersToAnotherGroup(groups.host, insertId)];
                case 3:
                    _a.sent();
                    _a.label = 4;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    new_host_id = _a.sent();
                    return [4 /*yield*/, moveUsersToAnotherGroup(group.id, new_host_id)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
...
function moveUsersToAnotherGroup(original_id, new_host_id) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        query = db_1.default.select('user_id', 'users_in_group', { field: 'host_id', value: original_id });
        db.query(query, function (err, results) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                for (_i = 0, user_members_1 = user_members; _i < user_members_1.length; _i++) {
                    ...
                    query = db_1.default.update('users_in_group', { field: 'host_id', value: original_id }, { field: 'host_id', value: new_host_id }, { field: 'user_id', value: user.user_id });
                    db.query(query, function (err, results) {
                        if (err) {
                            console.error("ERROR IN UPDATE QUERY>>>>>>>>>", err);
                        }
